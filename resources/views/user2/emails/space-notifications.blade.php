		...
		<div class="email_container" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; margin: 0 auto; max-width: 580px; font-size: 0 !important;">
										...
										<tbody>
											<tr>
												<td class="column_cell font_default image_thumb" align="center" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888;">
														...
														<tbody>
															...
															<tr>
																<td class="icon_cell" >
																	<?php 
																	$logo = $user1->Logo;
																	$logo = ($logo && file_exists(public_path() . $logo)) ? url('/') . $logo : url('/') . '/images/company-logo.jpg';
																	?>
																	<a style="padding: 8px; font-size: 0; line-height: 1; " href="<?php echo getUser1ProfileUrl($user1)?>"><img src="<?php echo $logo?>" width="100" height="100" alt="" style="line-height: 1; outline: none; border: 0; text-decoration: none; -ms-interpolation-mode: bicubic; mso-line-height-rule: exactly; -webkit-border-radius: 50px; border-radius: 50px;"></a>
																</td>
															</tr>
															<tr>
																<td class="hspace" style="padding: 0; font-size: 0; height: 8px; overflow: hidden;">&nbsp;</td>
													...
													<!--<p class="text-muted" style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 8px;margin-bottom: 8px;color: #b3b3b5;"><a href="#" style="display: inline-block;text-decoration: none;font-family: Helvetica, Arial, sans-serif;color: rgb(255, 193, 7);"><strong>Robert Allen</strong></a><br>
                            <small style="font-size: 86%;font-weight: normal;">15 Mar, 2017</small></p>-->
												</td>
										...
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: left; vertical-align: top; color: #888888;">
													<h5 >
														<a style="font-family: Helvetica, Arial, sans-serif; margin-left: 0; margin-right: 0; margin-top: 16px; margin-bottom: 8px; padding: 0; font-size: 18px; line-height: 26px; font-weight: bold; color: #383d42;" href="<?php echo getUser1ProfileUrl($user1)?>"><span class="text-secondary" style="color: rgb(255, 193, 7);">{{$user1->NameOfCompany}}</span></a>
														からオファーが届きました。
													</h5>
								...
								<div class="col-1" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 190px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default image_thumb" align="center" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888;">
													<?php foreach ($space['spaceImage'] as $image) {
														if ($image['Main']) {
													?>
														<a href="<?php echo getSpaceUrl($space->HashID)?>"><img src="<?php echo url('/') . $image['ThumbPath']?>" width="128" height="86" alt="" style="line-height: 1; outline: none; border: 0; text-decoration: none; -ms-interpolation-mode: bicubic; mso-line-height-rule: exactly; -webkit-border-radius: 4px; border-radius: 4px; margin-top: 25px;"></a>
													<?php
													}}
													?>
												</td>
								...
								<div class="col-13" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 390px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: left; vertical-align: top; color: #888888;">
													<small class="text-muted" style="font-size: 86%; font-weight: normal; color: #b3b3b5;"><?php echo $space['Type']?></small>
													<h6 ><a style="font-family: Helvetica, Arial, sans-serif; margin-left: 0; margin-right: 0; margin-top: 0; margin-bottom: 8px; padding: 0; font-size: 16px; line-height: 24px; font-weight: bold; color: #383d42;" href="<?php echo getSpaceUrl($space->HashID)?>">DAILY SPACE TEST</a></h6>
													<p class="lead" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; margin-top: 8px; margin-bottom: 8px;">
														<strong class="text-secondary" style="color: #888888;">
															<?php 
															$oSpace = (object)$space;
															echo getPrice($oSpace, true)?>
														</strong>
													</p>
													<p style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; line-height: 23px; margin-top: 8px; margin-bottom: 8px;">
														<?php echo str_limit($space['Details'], 80, '...')?>
													</p>
			...
			<table class="content" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
				<tbody>
					...
					<tr>
						<td class="content_cell" align="center" valign="top" style="padding: 0; text-align: center; background-color: #ffffff; font-size: 0 !important; border-top: 1px solid; border-color: #ebebeb;">
							<!--[if (gte mso 9)|(IE)]>
                <table width="580" border="0" cellspacing="0" cellpadding="0" align="center" style="vertical-align: top;">
                  <tbody>
                    <tr>
                  ...
                  <![endif]-->
								<div class="col-3 col-bottom-0" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 580px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888; padding-bottom: 20px;">
