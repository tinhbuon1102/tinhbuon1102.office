					...
					<div id="page-wrapper" class="nofix">
						...
						<div id="feed">
							<section class="feed-event recent-follow feed-box">
								<!--/show this if there is no added favourite-->
												...
												<div class="gry-border-box">
													<div class="office-catch-info clearfix">
														...
														<div class="office-feature-img">
															<a href="<?php echo getSpaceUrl($space->HashID)?>">
																<img class="wl-image" src="{{$img}}">
															</a>
														</div>
														<div class="office-catch-summary">
															<h3>
																<a href="<?php echo getSpaceUrl($space->HashID)?>">{{$space->Title}}</a>
															</h3>
															<p class="sp-price">
															...
															<p class="space-cat">
																プライベートオフィス
																<span class="capacity">{{$space->Capacity}}人</span>
															</p>
								...
								<div class="no-space-show">
									<i class="fa fa-star" aria-hidden="true"></i>
									<h1>まだお気に入り登録されていません</h1>
									<a href="{{url('RentUser/Dashboard/SearchSpaces')}}" class="yellow-button btn add-space-btn">
