														...
														<tbody>
															...
															<tr>
																<td class="icon_cell" style="padding: 8px; font-size: 0; line-height: 1; height: 48px; background-color: #e1e3e7; border-color: #ebebeb;">
																	<img src="{{getUser2Photo($user)}}" width="48" height="48" alt="" style="-webkit-border-radius: 80px; border-radius: 80px; line-height: 1; outline: none; border: 0; text-decoration: none; -ms-interpolation-mode: bicubic; mso-line-height-rule: exactly;">
																</td>
															</tr>
															<tr>
																<td class="hspace" style="padding: 0; font-size: 0; height: 8px; overflow: hidden;">&nbsp;</td>
														...
														<tbody>
															<tr>
																<td class="font_default" style="padding: 12px 24px; font-family: Helvetica, Arial, sans-serif; font-size: 16px; mso-line-height-rule: exactly; text-align: center; vertical-align: middle; -webkit-border-radius: 4px; border-radius: 4px; background-color: #1f1f1f;">
																	<a href="{{url('/')}}/Register-RentUser/VerifyEmail/{{ $user->EmailVerificationText }}" style="display: block; text-decoration: none; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-weight: bold; text-align: center;">
																		<span style="text-decoration: none; color: #ffffff; text-align: center; display: block;">メールアドレス認証</span>
																	</a>
																</td>
															</tr>
														</tbody>
								...
								<div class="col-3" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 580px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888;">
													<small style="font-size: 86%; font-weight: normal;">以下がアカウント登録の詳細です</small>
													...
													<p style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; line-height: 23px; margin-top: 16px; margin-bottom: 24px;">
														<strong>お名前: </strong> <span>{{getUserName($user)}}</span>
													</p>
													<p style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; line-height: 23px; margin-top: 16px; margin-bottom: 24px;">
														<strong>ふりがな: </strong>
