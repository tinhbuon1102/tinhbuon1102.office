			...
			<div ui-view="" class="ng-scope">
				<div class="signup-view ng-scope" ng-show="$root.pageLoaded" aria-hidden="false">
					<div class="form-container">
						...
						<form class="m-t ng-pristine ng-invalid ng-invalid-required" id="frm" method="post" action="/User1/Validate">
							{{ csrf_field() }}
							<div class="welcome-legend" ng-hide="loginError" aria-hidden="false">
								<span class="label">シェア会員ログインフォーム</span>
							</div>
							<div class="HomepageAuth-facebookWrapper">
								<a href="/FBLoginRedirect?looking_for=ShareUser">
