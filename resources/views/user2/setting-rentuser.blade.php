									...
									<div class="form-container">
										...
										@endif
											...
											<div class="user-setting">
												...
												<fieldset>
													<div class="Signup-sectionHeader">
														<legend class="signup-sectionTitle">本人確認情報<!--5%--></legend>
													</div>
                                                    <?php if(!$user->SentToAdmin) {?>
                                                    <div class="alert-identity-message">
                                                        本人確認書類が提出されていません。本人証明が完了後、アカウントの制限は解除されます。
													</div>
                                                    <div class="btn-group">
                                                    ...
                                                    <?php } else {?>
                                                    <div class="alert-identity-message">
														只今本人確認中です。本人確認が終わり次第、アカウントの制限は解除されます。
                                                        </div>
                                                        <div class="btn-group">
												...
												<fieldset>
													<div class="Signup-sectionHeader">
														<legend class="signup-sectionTitle">アカウント情報<!--5%--></legend>
													</div>
													<div class="form-field two-inputs">
														...
														<div class="input-container input-half">
														  <form method="post" id="chgemail" action="/RentUser/Dashboard/ChangeEmail">
															<label for="Email">メールアドレス&nbsp;<a href="#!" class="label-link" id="changeEmail">[変更]</a></label>
														  ...
														  <!--if email is not verified yet-->
                                                             <?php if($user->IsEmailVerified=="No"){ ?><div class="no-verify-alert"><span class="not-verify-yet">あなたのメールアドレスは認証されてません。</span><a href="#" class="verify-now btn btn-info" id="verifyEmail">メールアドレスを認証</a></div><?php } ?>
                                                            <!--/if email is not verified yet-->
														</div>
													</div>
													<!--/form-field-->
											...
											{{ csrf_field() }}
												<fieldset>
													<div class="Signup-sectionHeader">
														<legend class="signup-sectionTitle">お名前<!--5%--></legend>
													</div>
													<div class="form-field two-inputs">
														<div class="input-container input-half">
															<label for="last_name">
...
for($i = 1; $i<=31; $i++):?>
												...
												<fieldset>
													<div class="Signup-sectionHeader">
														<legend class="signup-sectionTitle">住所<!--10%--></legend>
													</div>
													<div class="form-field two-inputs">
														<div class="input-container input-half">
															<label for="zip">
													...
													<div class="form-field two-inputs">
														<div class="input-container input-half">
															...
															<?php echo Form::select('Prefecture',
																getPrefectures(), 
																$user->Prefecture, 
																['id' => 'Prefecture', 'class' => 'ng-pristine ng-untouched ng-invalid-required', 'required' => 'required']);
															?>
														</div>
														<div class="input-container input-half">
															<label for="city">
													...
													<div class="form-field two-inputs">
														<div class="input-container input-half">
															...
															<select id="UserType" name="UserType" required class="old_ui_selector">
																<option value="個人事業主" selected="">個人事業主<!--5%--></option>
                                                ...
                                                <div class="Signup-sectionHeader">
                                                <div class="row">
                                                <div class="col-xs-6 col-md-6 col-sm-8"><legend class="signup-sectionTitle"><?=trans("common.My Payment Method")?><!--支払情報--></legend></div>
                                                <div class="col-xs-6 col-md-6 col-sm-4 clearfix pb15 text-right">
                                                <a href="#modal5" class="btn btn-default mt15 dblk-button mgt-0"><i class="fa fa-plus-circle" aria-hidden="true"></i>
							...
							<div class="PaymentMethods-controls">
								<div class="PaymentMethods-verify">
									...
									<a href="#modal6">Edit</a> | <a href="{{Url('/')}}/RentUser/Dashboard/BasicInfo/remove">Remove</a>
									</span>
								</div>
                        ...
                        @endif
                                                    @include('user2.dashboard.paypal-authenticate')
                                                    </ul>
                                                    </div>
                                                    </div>
    ...
    <div class="modal-header-payment">Add Payment Method</div>
    <button data-remodal-action="close" class="remodal-close"><img src="/images/cross-icons.png" /></button>
    </div>
    <div class="modal-body"><form id="basicinfo" class="fl-form" action="{{ url('RentUser/Dashboard/BasicInfo/Edit') }}" method="post">
	<input type="hidden" name="_token" id="" value="{{ csrf_token() }}">
                                                    ...
                                                    <label for="payment_method_cc"><?=trans("common.Credit Card")?></label></span>
                                                    ...
                                                    <button class="btn btn-default mt15 paypal-btn mgt-0"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> Add Credit Card</button>
                                                    </div>
                                                    </li>
                                                    <li class="payment_method_paypal">
                                                    <span class="radio-wrap clearfix"><input id="payment_method_paypal" type="radio" class="input-radio" name="payment_method" value="paypal" onclick="entryChange1();">
                                                    <label for="payment_method_paypal">Paypal</label></span>
                                                    ...
                                                    <a href="#" onclick="return false;" id="ppAdd" class="btn mt15 paypal-btn mgt-0"><i class="fa fa-paypal" aria-hidden="true"></i> Paypal</a><img  style="display:none;" id="ppLoader" alt="paypal Loading..." src="https://cdn3.f-cdn.com/img/ajax-loader.gif?v=62d3d0c60d4c33ef23dcefb9bc63e3a2&amp;m=6">
                                                    </div>
                                                    </li>
                                                    </ul>
                                                    </div>
    ...
    <div class="HomepageAuth-inner">
    <div class="modal-header dialog-title-bar">
    <div class="modal-header-payment">Edit Card Number</div>
    <button data-remodal-action="close" class="remodal-close"><img src="/images/cross-icons.png" /></button>
    </div>
    <div class="modal-body"><form id="basicinfo" class="fl-form" action="{{ url('RentUser/Dashboard/BasicInfo/Edit') }}" method="post">
	<input type="hidden" name="_token" id="" value="{{ csrf_token() }}">
                                                    ...
                                                    <li class="payment_method_cc">
                                                    <span class="radio-wrap clearfix">
                                                    <label for="payment_method_cc">クレジットカード編集</label></span>
                                                    ...
                                                    <button class="btn btn-default mt15 paypal-btn mgt-0">Update</button>
                                                    </div>
                                                    </li>
                                                    </ul>
                                                    </div>
