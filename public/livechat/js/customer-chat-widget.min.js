...
function(t, e) {
    t.MessageModel = Backbone.Model.extend({
        ...
        initialize: function(t, e) {
            if (this.options = e || {},
            t) {
                if ("string" == typeof t.datetime ? this.set("time", new Date(t.datetime.replace(/-/g, "/"))) : "object" == typeof t.datetime && this.set("time", t.datetime),
                "string" == typeof t.from_user_info && "all" !== t.from_user_info)
                    try {
                ...
                if ("object" == typeof t.from_user_info) {
                    ...
                    this.fromUser = i,
                    0 === this.get("author").length && this.set("author", i.name),
                    this.has("authorMail") || this.set("authorMail", i.mail)
                }
                if ("string" == typeof t.to_user_info && "all" !== t.to_user_info)
                    try {
                ...
                if ("object" == typeof t.to_user_info) {
                    ...
                    this.toUser = o,
                    this.set("toAuthor", o.name),
                    this.set("toAuthorMail", o.mail)
                }
            }
        },
        getAge: function() {
    ...
    var o = t.GuestChatModel = Backbone.Model.extend({
        ...
        autoLogin: function() {
            ...
            e.post(s.isLoggedInPath, {
                ...
                t.trigger("login:success"),
                e.get(s.lastMessagesPath, function(e) {
        ...
        login: function(t) {
            var i = this;
            t.info = JSON.stringify(s.info),
            e.post(s.loginPath, t, function(e) {
                e.success ? (i.set({
                    name: t.name,
                    mail: t.mail,
                    image: t.image
        ...
        updateTypingStatus: function() {
            ...
            if (t) {
                ...
                this.lastTypingUpdate + o.POLLING_INTERVAL < i && (this.lastTypingUpdate = i,
                e.post(s.updateTypingStatusPath, {
                    secondUserId: t,
                    status: !0
                }))
            }
        ...
        loadOperatorsData: function(t, i) {
            for (var o = this, n = 0, a = 0; a < t.length; a++) {
                var h = t[a];
                this.operatorsCache[h.from_id] || (n++,
                e.post(s.getOperatorPath, {
                    id: h.from_id
                }).success(function(t) {
        ...
        sendMessage: function(t, i) {
            ...
            e.post(s.sendMessagePath, o, function(t) {
                t.success ? n.trigger("messages:sent") : n.trigger("messages:sendError"),
                i && i(t)
            }),
        ...
        manageConnection: function() {
            ...
            this.connectionTimer = setInterval(e.proxy(this._manageConnection, this), o.POLLING_INTERVAL),
        ...
        prevRequestsComplete: function() {
            if (Date.now() - this.requestInitTime > o.REQUEST_STATUS_RESET_TIMEOUT)
                return this.initRequestsStatus(),
                !0;
            for (var t in this.requestsStatus)
                if (!this.requestsStatus[t])
                    return !1;
...
function(t, e, s) {
    t.LoginFormView = Backbone.View.extend({
        ...
        reset: function() {
            ...
            "true" !== s.ui.askForMail && this.$mail.hide().val("anonymous@anonymous.anonymous")
        },
        validateName: function() {
            0 == this.$name.val().length ? (this.$name.addClass("customer-chat-input-error"),
            this.nameValid = !1) : (this.$name.removeClass("customer-chat-input-error"),
            this.nameValid = !0)
        },
        validateMail: function() {
            0 != this.$mail.val().length && this.mailExp.test(this.$mail.val()) ? (this.$mail.removeClass("customer-chat-input-error"),
            this.mailValid = !0) : (this.$mail.addClass("customer-chat-input-error"),
            this.mailValid = !1)
        },
        isValid: function() {
            return this.validateName(),
            this.validateMail(),
            this.nameValid && this.mailValid
        }
    })
...
function(t, e) {
    t.ContactFormView = Backbone.View.extend({
        ...
        validateMessage: function() {
            this.$message.val().length < 6 ? (this.$message.addClass("customer-chat-input-error"),
            this.messageValid = !1) : (this.$message.removeClass("customer-chat-input-error"),
            this.messageValid = !0)
        },
        isValid: function() {
            return this.validateName(),
...
function(t, e, s) {
    var i = /(\w+:\/\/)?([\da-z\.\-@]+)\.([a-z\.]{2,})([?&=%#;\/\w\.-]*)*\/?/g
      , o = t.MessageView = Backbone.View.extend({
        ...
        render: function() {
            this.$el.html(s(t.template.message)),
            this.$time = this.$(".customer-chat-content-message-time");
            var e = this.model.get("body").split("<").join("&lt;").split(">").join("&gt;");
            e = this.prepareMessage(e),
            this.$(".customer-chat-content-message-author").html(this.model.getReadableName() || this.model.get("author")),
            this.$(".customer-chat-content-message-body").html(e),
            this.updateTime(!0),
            "operator" == this.model.get("authorType") && (this.$(".customer-chat-content-message").removeClass("customer-chat-content-message").addClass("customer-chat-content-message-operator"),
            ...
            this.model.fromUser && this.model.fromUser.image && this.$(".avatar").css("background-image", 'url("' + this.model.fromUser.image + '")'),
            t.UserInfoPopoverView && new t.UserInfoPopoverView({
                model: this.model,
        ...
        prepareMessage: function(t) {
            ...
            this.settings.get("emots"))
                for (var e in o.EMOTICONS)
                    t = t.split(e).join(o.createEmotElement(o.EMOTICONS[e]));
            return t
        },
        ...
        clean: function() {
            return this.timerId && clearTimeout(this.timerId),
            this
        }
    }, {
        EMOTICONS: {
...
function(t, e) {
    t.ChatBoxView = Backbone.View.extend({
        ...
        addMessage: function(e, s, i) {
            ...
            setTimeout(function() {
                n.updateScroller(),
                i ? s && n.$el.mCustomScrollbar("scrollTo", "bottom") : (n.settings.get("scroll") || s) && n.$el.mCustomScrollbar("scrollTo", "bottom")
            }, 200)
        },
        clear: function() {
...
function(t, e, s) {
    var i = t.WidgetView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            s.mobile && this.show(),
            "true" === s.ui.autoShowWidget && (this.autoShowTimer = setTimeout(e.proxy(this.show, this), 1e3 * s.ui.autoShowWidgetAfter))
        },
        setState: function(e) {
            if (this.state != e)
                switch (this.state = e,
                ...
                case "loading":
                    ...
                    this.$title.html(s.ui.loadingLabel);
                    break;
                case "chat":
                    this.$el.addClass("chat-box"),
                    this.$title.html(s.ui.chatHeader);
                ...
                case "contact":
                    ...
                    this.$title.html(s.ui.contactHeader),
                    this.fullscreenOff(),
                    this.prevState = e;
                    break;
                case "info":
        ...
        show: function() {
            this.visible = !0,
            this.autoShowTimer && (clearTimeout(this.autoShowTimer),
        ...
        hide: function() {
            this.visible = !1,
            this.storeProperties(e.proxy(function() {
        ...
        close: function() {
            history.length > 1 ? history.back() : (window.open("", "_self"),
            window.close())
        },
        autoLogin: function() {
            this.showLoading(),
        ...
        login: function() {
            ...
            this.loginForm.isValid() && (this.showLoading(),
            this.model.login(t))
        },
        ...
        toggleSettings: function() {
            this.visible && (this.$settings.is(":visible") ? (this.$settings.fadeOut("fast"),
            this.$endChatConfirmation.hide(),
            this.$endChat.show()) : this.$settings.fadeIn("fast"))
        },
        ...
        addEmoticon: function(t) {
            ...
            this.$input.val(this.$input.val() + " " + i.data("emot") + " "),
            s.mobile || this.$input.focus(),
            this.$emoticons.fadeOut("fast")
        },
        handleMessages: function(s) {
            for (var i = 0; i < s.length; i++) {
                var o = s[i];
                o.authorType = "operator",
                o.author = this.model.getOperatorName(o.from_id);
                var n = new t.MessageModel(o);
                n.fromUser = o.from_user_info,
                this.chatBox.addMessage(n)
            }
            this.settings.get("sound") && t.service.soundPlayer.play("message"),
            this.visible || (this.settings.get("show") ? this.toggle() : this.startTitleBlink()),
            this.$mobileTitle.is(":visible") && (this.stopTitleBlink(),
        ...
        sendMessage: function() {
            ...
            0 != t.length && (this._sendMessage(t),
            this.$input.val(""))
        },
        ...
        handleOperatorTyping: function() {
            ...
            this.stopTypingBlinkTimer = setTimeout(e.proxy(this.stopTypingInfoBlink, this), i.TYPING_STATUS_TIME)
        },
        sendContactMessage: function() {
            ...
            if (this.contactForm.isValid()) {
                ...
                e.post(s.contactPath, t, function(t) {
                    t.success ? (i.contactForm.reset(),
                    i.showInfo(s.ui.contactSuccessMessage, s.ui.contactSuccessHeader)) : i.showInfo(s.ui.contactErrorMessage, s.ui.contactErrorHeader)
                }),
                this.showLoading()
            }
        },
        ...
        startTypingInfoBlink: function() {
            this.typingInfoBlinking || (this.typingInfoBlinking = !0,
        ...
        storeProperties: function(t) {
            if (!s.mobile && !this.fullscreen) {
                ...
                this.postMessage("get.properties", function(s) {
                    var i = s.split(",");
                    e.frameWidth = parseInt(i[0]),
                    e.frameHeight = parseInt(i[1]),
                    e.frameOffset = parseInt(i[2]),
                    t && t()
                })
            }
        },
        postMessage: function(t, e) {
            if (!s.mobile && (window.parent.postMessage(t, "*"),
            e)) {
                var i = this.$window
...
function(t, e, s) {
    t.SelectAvatarInlineView = Backbone.View.extend({
        ...
        render: function() {
            return this.$el.html(t.template.selectAvatarContent),
...
jQuery(function(t) {
    ...
    t.get(e.templatesPath, function(e) {
        ...
        i.service.soundPlayer = new i.SoundPlayer,
        i.template.message = s.find("#message").html(),
        i.model.settings = new i.GuestSettingsModel,
        i.model.chat = new i.GuestChatModel,
        i.view.widget = new i.WidgetView({
            el: "#customer-chat-widget",
            model: i.model.chat
        }),
        window.phpLiveChat = new i.WidgetFacade,
        new i.PostMessageApiAdapter(window.phpLiveChat)
    })
});
