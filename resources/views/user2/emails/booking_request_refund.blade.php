...
.font_default,h1,h2,h3,h4,h5,h6,p,a {
	...
	/* this is used for email clients that don't support webfonts */
}
...
.header_cell,.secondary_btn td,.icon_primary .icon_cell,.primary_pricing_box
	{
	background-color: rgb(255, 193, 7);
}

.jumbotron_cell,.footer_cell,.pricing_box {
...
.header_cell .column_cell,.header_cell a,.header_cell a span,.primary_btn a,.primary_btn span,.secondary_btn a,.secondary_btn span,.label .font_default,.primary_pricing_box,.primary_pricing_box h1,.primary_pricing_box small
	{
	color: #ffffff;
}
...
h1,h3,a,a span,.text-secondary,.column_cell .text-secondary,.content_cell h2 .text-secondary
	{
	color: rgb(255, 193, 7);
}
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="margin: 0; padding: 0; min-width: 100%; background-color: #ebebeb;">
	<div class="email_body" style="padding: 32px 10px; text-align: center; background-color: #ebebeb;">
		<!--[if (gte mso 9)|(IE)]>
  ...
  <![endif]-->
		<div class="email_container" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; margin: 0 auto; max-width: 580px; font-size: 0 !important;">
			<table class="header" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
				<tbody>
					<tr>
						<td class="header_cell col-bottom-0" align="center" valign="top" style="padding: 0; text-align: center; padding-bottom: 16px; -webkit-border-radius: 4px 4px 0 0; border-radius: 4px 4px 0 0; background-color: rgb(255, 193, 7); font-size: 0 !important;">
							<!--[if (gte mso 9)|(IE)]>
                <table width="580" border="0" cellspacing="0" cellpadding="0" align="center" style="vertical-align: top;">
                  <tbody>
                    <tr>
			...
			<table class="jumbotron" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
				<tbody>
					<tr>
						<td class="jumbotron_cell" align="center" valign="top" style="padding: 0; text-align: center; background-color: #f9f8fb; font-size: 0 !important;">
							<!--[if (gte mso 9)|(IE)]>
                <table width="580" border="0" cellspacing="0" cellpadding="0" align="center" style="vertical-align: top;">
                  <tbody>
                    <tr>
										...
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888;">
													<h2 style="font-family: Helvetica, Arial, sans-serif; margin-left: 0; margin-right: 0; margin-top: 16px; margin-bottom: 8px; padding: 0; font-size: 26px; line-height: 36px; font-weight: bold; color: #383d42;">予約のキャンセルを受け付けました。</h2>
													<p class="lead" style="font-family: Helvetica, Arial, sans-serif; font-size: 19px; line-height: 27px; margin-top: 16px; margin-bottom: 16px;">以下のスペース予約がキャンセルされました。</p>
												</td>
												<!-- /.column_cell -->
											</tr>
										</tbody>
                ...
                <table width="580" border="0" cellspacing="0" cellpadding="0" align="center" style="vertical-align: top;">
                  <tbody>
                    <tr>
                      <td width="580" align="center" valign="top">
                <![endif]-->
							<h4 style="font-family: Helvetica, Arial, sans-serif; margin-left: 0; margin-right: 0; margin-top: 8px; margin-bottom: 0px; padding: 0; font-size: 16px; line-height: 26px; font-weight: bold; color: #383d42;">予約内容</h4>
							<!--[if (gte mso 9)|(IE)]>
                      </td>
                    </tr>
                  </tbody>
								...
								<div class="col-1" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 190px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="left" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888;">
													<p class="no_mgn" style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; line-height: 23px; margin-top: 0px; margin-bottom: 0px;">利用者</p>
												</td>
												<!-- /.column_cell:image_thumb -->
											</tr>
										</tbody>
								...
								<div class="col-13" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 390px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: left; vertical-align: top; color: #000000;">
													<p class="no_mgn" style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; font-weight: bold; line-height: 23px; margin-top: 0px; margin-bottom: 0px;"><a href="{{getUser2ProfileUrl($rent_data->rentUser)}}">{{getUserName($rent_data->rentUser)}}</a></p>
												</td>
												<!-- /.column_cell -->
											</tr>
										</tbody>
								...
								<div class="col-13" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 390px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: left; vertical-align: top; color: #000000;">
													<p class="no_mgn" style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; font-weight: bold; line-height: 23px; margin-top: 0px; margin-bottom: 0px;">
								...
								<div class="col-1" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 190px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="left" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888;">
													<p class="no_mgn" style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; line-height: 23px; margin-top: 0px; margin-bottom: 0px;">利用期間</p>
												</td>
												<!-- /.column_cell:image_thumb -->
											</tr>
										</tbody>
                ...
                <table width="580" border="0" cellspacing="0" cellpadding="0" align="center" style="vertical-align: top;">
                  <tbody>
                    <tr>
                      <td width="580" align="center" valign="top">
                <![endif]-->
							<h4 style="font-family: Helvetica, Arial, sans-serif; margin-left: 0; margin-right: 0; margin-top: 8px; margin-bottom: 0px; padding: 0; font-size: 16px; line-height: 26px; font-weight: bold; color: #383d42;">支払情報</h4>
							<!--[if (gte mso 9)|(IE)]>
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <![endif]-->
								<div class="col-1" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 190px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="left" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888;"></td>
												<!-- /.column_cell:image_thumb -->
											</tr>
										</tbody>
									</table>
											...
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: right; vertical-align: top; color: #888888;">
													...
													<span class="red" style="color:red">
														返金<?php echo getRefundTypeText($rent_data)?>
														<strong>-{{priceConvert($rent_data->amount - $rent_data->refund_amount, true)}}</strong>
													</span>
											...
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: right; vertical-align: top; color: #888888;">
													<h5 style="font-family: Helvetica, Arial, sans-serif; margin-left: 0; margin-right: 0; margin-top: 16px; margin-bottom: 8px; padding: 0; font-size: 18px; line-height: 26px; font-weight: bold; color: #383d42;">
														...
														<span class="text-secondary strike" style="color: #888888;font-weight: normal;text-decoration: line-through;">{{$totalPrice}}</span>
														&nbsp;&nbsp;
														<span class="text-secondary" style="color: rgb(255, 193, 7);">{{priceConvert($rent_data->refund_amount, true)}}</span>
													</h5>
												</td>
												<!-- /.column_cell -->
											</tr>
								...
								<div class="col-1" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 190px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="left" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: center; vertical-align: top; color: #888888;">
													<p class="no_mgn" style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; line-height: 23px; margin-top: 0px; margin-bottom: 0px;">支払方法</p>
												</td>
												<!-- /.column_cell:image_thumb -->
											</tr>
										</tbody>
								...
								<div class="col-13" style="display: inline-block; width: 100%; vertical-align: top; text-align: center; max-width: 390px;">
									<table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; vertical-align: top;">
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px 16px 0; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: left; vertical-align: top; color: #000000;">
													<p class="no_mgn" style="font-family: Helvetica, Arial, sans-serif; font-size: 15px; font-weight: bold; line-height: 23px; margin-top: 0px; margin-bottom: 0px;">{{getPaymentMethod($rent_data)}}</p>
												</td>
												<!-- /.column_cell -->
											</tr>
										</tbody>
										...
										<tbody>
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px; font-family: Helvetica, Arial, sans-serif; font-size: 12px; text-align: center; vertical-align: top; color: #888888;">
													下記のリンクから予約を確認、承認することができます。
													<br />
													※処理中から予約承認にステータスを変更しなければ、予約受付は完了となりません。
													<br />
													詳しくは詳細ページにてご確認ください。
												</td>
											</tr>
														...
														<tbody>
															<tr>
																<td class="font_default" style="padding: 12px 24px; font-family: Helvetica, Arial, sans-serif; font-size: 16px; mso-line-height-rule: exactly; text-align: center; vertical-align: middle; -webkit-border-radius: 4px; border-radius: 4px; background-color: rgb(255, 193, 7);">
																	<a target="_blank" href="{{url('ShareUser/Dashboard/EditBook/' . $rent_data->id)}}" style="display: block; text-decoration: none; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-weight: bold; text-align: center;">
			...
			<table class="footer" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
				<tbody>
					<tr>
						<td class="footer_cell" align="center" valign="top" style="padding: 0; text-align: center; padding-bottom: 16px; -webkit-border-radius: 0 0 4px 4px; border-radius: 0 0 4px 4px; background-color: #f9f8fb; border-top: 1px solid; border-color: #ebebeb; font-size: 0 !important;">
							<!--[if (gte mso 9)|(IE)]>
                <table width="580" border="0" cellspacing="0" cellpadding="0" align="center" style="vertical-align: top;">
                  <tbody>
                    <tr>
											...
											<tr>
												<td class="column_cell font_default" align="center" valign="top" style="padding: 16px; font-family: Helvetica, Arial, sans-serif; font-size: 15px; text-align: left; vertical-align: top; color: #b3b3b5; padding-bottom: 0; padding-top: 16px;">
													<a href="#" style="display: inline-block; text-decoration: none; font-family: Helvetica, Arial, sans-serif; color: #7a7a7a;">
														&nbsp;
														<img src="<?php echo url('/')?>/images/ic_facebook.png" width="24" height="24" alt="" style="line-height: 1; outline: none; border: 0; text-decoration: none; -ms-interpolation-mode: bicubic; mso-line-height-rule: exactly;">
														&nbsp;
													</a>
													&nbsp;
													<a href="#" style="display: inline-block; text-decoration: none; font-family: Helvetica, Arial, sans-serif; color: #7a7a7a;">
														&nbsp;
														<img src="<?php echo url('/')?>/images/ic_twitter.png" width="24" height="24" alt="" style="line-height: 1; outline: none; border: 0; text-decoration: none; -ms-interpolation-mode: bicubic; mso-line-height-rule: exactly;">
														&nbsp;
													</a>
													&nbsp;
													<a href="#" style="display: inline-block; text-decoration: none; font-family: Helvetica, Arial, sans-serif; color: #7a7a7a;">
														&nbsp;
														<img src="<?php echo url('/')?>/images/ic_youtube.png" width="24" height="24" alt="" style="line-height: 1; outline: none; border: 0; text-decoration: none; -ms-interpolation-mode: bicubic; mso-line-height-rule: exactly;">
														&nbsp;
													</a>
												</td>
												<!-- /.column_cell -->
