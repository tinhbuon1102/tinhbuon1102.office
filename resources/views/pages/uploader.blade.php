	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myLargeModalLabel">写真をアップロード</h4>
			</div>
			<div class="modal-body">
				<div class="crop_set_preview">
					<div class="crop_preview_left">
						...
						<form name="thumbnail" action="{{ Request::url()  }}/UploadImage" method="post">
							{{ csrf_field() }} 
							...
							<div class="crop_preview_submit">
								<input type="submit" name="upload_thumbnail" value="メイン画像として設定" id="save_thumb" class="btn btn-success submit_button" />
							</div>
							<input type="hidden" name="backurl" value="{{Request::url()}}" />
							<input type="hidden" name="upload_thumbnail" value="Set as Profile Picture"  />
						</form>

						<form class="uploadform" method="post" enctype="multipart/form-data" action='upload-image.php' name="photo">
							{{ csrf_field() }} 
